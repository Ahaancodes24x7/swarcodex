...
export const translations: Translations = {
  ...
  'hero.title': { en: 'Multimodal AI for Early Detection of Dyslexia & Dyscalculia', hi: 'डिस्लेक्सिया और डिस्कैलक्यूलिया की प्रारंभिक पहचान के लिए मल्टीमॉडल AI', pa: 'ਡਿਸਲੈਕਸੀਆ ਅਤੇ ਡਿਸਕੈਲਕੁਲੀਆ ਦੀ ਜਲਦੀ ਪਛਾਣ ਲਈ ਮਲਟੀਮੋਡਲ  AI', ta: 'டிஸ்லெக்சியா & டிஸ்கால்குலியாவை முன்கூட்டியே கண்டறிய குரல்  மல்டிமோடல் AI', te: 'డిస్లెక్సియా & డిస్కాల్క్యులియా త్వరగా గుర్తించడానికి మల్టీమోడల్ AI' },
