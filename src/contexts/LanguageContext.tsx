...
export const translations: Translations = {
  ...
  'hero.title': { en: 'AI-Powered Voice and Written Screening for specific learning disabilities', hi: 'विशिष्ट अधिगम विकलांगताओं के लिए एआई-संचालित आवाज़ और लिखित स्क्रीनिंग', pa: 'ਖਾਸ ਸਿੱਖਣ ਸੰਬੰਧੀ ਅਪੰਗਤਾਵਾਂ ਲਈ ਏਆਈ-ਸੰਚਾਲਿਤ ਆਵਾਜ਼ ਅਤੇ ਲਿਖਤੀ ਸਕ੍ਰੀਨਿੰਗ', ta: 'குறிப்பிட்ட கற்றல் ஊனமுறைகளுக்கான AI மூலம் இயக்கப்படும் குரல் மற்றும் எழுத்து திரையிடல்', te: 'ప్రత్యేక అభ్యాస వికలాంగతల కోసం AI ఆధారిత వాయిస్ మరియు రాత స్క్రీనింగ్' },
  'hero.description': { en: 'SWAR uses voice and written analysis powered by AI to identify learning differences early , empowering educators and parents to provide timely support.', hi: 'SWAR एआई द्वारा संचालित आवाज़ और लिखित विश्लेषण का उपयोग करके सीखने की कठिनाइयों की शुरुआती पहचान करता है, जिससे शिक्षकों और माता-पिता को समय पर सहायता प्रदान करने में सशक्त बनाया जाता है।', pa: 'SWAR ਏਆਈ ਦੁਆਰਾ ਸੰਚਾਲਿਤ ਆਵਾਜ਼ ਅਤੇ ਲਿਖਤੀ ਵਿਸ਼ਲੇਸ਼ਣ ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਸਿੱਖਣ ਦੀਆਂ ਸਮੱਸਿਆਵਾਂ ਦੀ ਸ਼ੁਰੂਆਤੀ ਪਛਾਣ ਕਰਦਾ ਹੈ, ਜਿਸ ਨਾਲ ਅਧਿਆਪਕਾਂ ਅਤੇ ਮਾਪਿਆਂ ਨੂੰ ਸਮੇਂ ਸਿਰ ਸਹਾਇਤਾ ਪ੍ਰਦਾਨ ਕਰਨ ਲਈ ਸਮਰੱਥ ਬਣਾਇਆ ਜਾਂਦਾ ਹੈ।', ta: 'SWAR AI மூலம் இயக்கப்படும் குரல் மற்றும் எழுத்து பகுப்பாய்வை பயன்படுத்தி கற்றல் சிக்கல்களை ஆரம்பத்திலேயே கண்டறிந்து, ஆசிரியர்கள் மற்றும் பெற்றோர்கள் சரியான நேரத்தில் ஆதரவு வழங்க அதிகாரமளிக்கிறது', te: 'SWAR AI ఆధారిత వాయిస్ మరియు రాత విశ్లేషణను ఉపయోగించి అభ్యాస భేదాలను తొలిదశలోనే గుర్తించి, ఉపాధ్యాయులు మరియు తల్లిదండ్రులు సమయానికి సహాయం అందించేందుకు శక్తివంతం చేస్తుంది.' },
  ...
  'dashboard.written_test': { en: 'written test', hi: 'लिखित परीक्षा', pa: 'ਲਿਖਤੀ ਟੈਸਟ', ta: 'எழுத்துத் தேர்வுு', te: 'వ్రాత పరీక్ష' },
